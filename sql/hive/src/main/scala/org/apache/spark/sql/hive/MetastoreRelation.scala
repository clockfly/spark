...
// TODO: Change this to HIVe irrelevant.
// All info should be retrieved from external catalog...
...
//     @transient private val client: HiveClient,
  ...
  // TODO: Statistics is stored in side ExternalCatalog
  @transient override lazy val statistics: Statistics = null
...
//  }
  ...
  // TODO: allPartitions is stored inside external catalog.
  private lazy val allPartitions: Seq[CatalogTablePartition] = null
//  // When metastore partition pruning is turned off, we cache the list of all partitions to
//  // mimic the behavior of Spark < 1.5
//  // Partition info is stored inside external catalog.
...
//  }
  ...
  // TODO: inputFiles is stored inside external catalog...
  override def inputFiles: Array[String] = null
